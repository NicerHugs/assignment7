...
var avgPrice = items.map(function(item) {
  return item.price;}).reduce(function(a,b) {
    return a+b;
  })/items.length;

console.log("The average price is $" + Math.floor(avgPrice*100)/100);

// QUESTION TWO
// Show me how to get an array of items that cost between $14.00 and $18.00 USD
// The output should be:
//
// "Items that cost less than $15.00 USD:"
// [
//   {
...
var usdPrice14_18 = items.filter(function(item) {
